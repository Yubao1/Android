...
import static com.example.administrator.myapplication.tool.FileUtil.getRealFilePathFromUri;
...
import com.example.administrator.myapplication.activitys.ClipImageActivity;
...
public class PhotoUtil {
    ...
    private void openCamera() {
        ...
        if (outputImage == null) {
            Log.d("outputImage","outputImage为空");
        } else {
            Log.d("outputImage","outputImage不为空");
        }
        try {
