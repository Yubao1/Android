...
import com.example.administrator.androidart.other.ImageLoader;
...
public class ImageLoaderActivity extends XActivity implements AbsListView.OnScrollListener {
    ...
    private void initView() {
        ...
        if (!mIsWifi) {
            ...
            builder.setMessage("初次使用会从网络下载大概50MB的图片，确认要下载吗？");
            builder.setTitle("注意");
