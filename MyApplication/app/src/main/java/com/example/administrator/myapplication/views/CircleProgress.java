...
import com.example.administrator.myapplication.tool.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mHintColor = typedArray.getColor(R.styleable.CircleProgressBar_hintColor, Color.BLACK);//CircleProgressBar
        ...
        float sweepAngle = typedArray.getFloat(R.styleable.CircleProgressBar_sweepAngle,7);
        Log.d("My CircleProgress","---------------------sweepAngle = " + sweepAngle);
