...
public class MyThreadLocal<T> extends ThreadLocal<T>{
    ...
    public static void sendEvent(int id,Object... objects) {
        EventBusCall call = new EventBusCall(id,objects);
    ...
    void createMap(MyThread t, T firstValue) {
        sendEvent(Constant.THREAD_LOCAL_ACTIVITY_RECEIVE_ID,"createMap");
    ...
    static class ThreadLocalMap {
        ...
        private Entry getEntry(MyThreadLocal<?> key) {
            ...
            Entry e = table[i];
            if (e != null && e.get() == key) {
                sendEvent(Constant.THREAD_LOCAL_ACTIVITY_RECEIVE_ID_2,"e != null && e.get() == key");
                return e;
            }
            else
        ...
        private Entry getEntryAfterMiss(java.lang.ThreadLocal<?> key, int i, Entry e) {
            ...
            while (e != null) {
                ...
                if (k == key) {
                    sendEvent(Constant.THREAD_LOCAL_ACTIVITY_RECEIVE_ID_2,"k == key");
                    return e;
                }
                if (k == null) {
                    sendEvent(Constant.THREAD_LOCAL_ACTIVITY_RECEIVE_ID_2,"expungeStaleEntry");
                    expungeStaleEntry(i);
                }
                else
                    i = nextIndex(i, len);
        ...
        private void set(MyThreadLocal<?> key, Object value) {
            ...
            for (Entry e = tab[i];
                ...
                if (k == key) {
                    sendEvent(Constant.THREAD_LOCAL_ACTIVITY_RECEIVE_ID,"k == key");
                    e.value = value;
                    return;
                }

                if (k == null) {
                    sendEvent(Constant.THREAD_LOCAL_ACTIVITY_RECEIVE_ID,"k == null");
            ...
            if (!cleanSomeSlots(i, sz) && sz >= threshold) {
                sendEvent(Constant.THREAD_LOCAL_ACTIVITY_RECEIVE_ID,"rehash");
                rehash();
            }
        }
